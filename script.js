...
function showImprovementPlanTutorial() {
  ...
  if (condition == 0) {
    ...
    document.getElementById("improvementPlanTutorialPage").innerHTML += `<p><b>Key Concepts:</b></p><p> We will now assess your decision making behavior based on your responses to the first 25 tasks and will generate an improvement plan to help you increase your accuracy for the next 25 tasks. </p>
